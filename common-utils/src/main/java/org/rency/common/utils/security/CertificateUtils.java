...
public class CertificateUtils {
    ...
    public static void main(String[] args) throws Exception {
    	String password = "casserver";
		String alias = "cas";
		String data = "这是一个测试类";
		String certificatePath = "D:/cas.crt";
		String keyStorePath = "D:/cas.keystore";
		
		System.out.println("******************* 公钥加密-私钥解密 *********************");
		byte[] encryptData = encryptByPublicKey(data.getBytes(),certificatePath);
		byte[] decryptData = decryptByPrivateKey(encryptData,keyStorePath,alias,password);
		System.out.println("加密前:"+data+"\r\n"+"解密后:"+new String(decryptData));
		
		System.out.println("******************* 证书有效性 *********************");
		System.out.println(verifyCertificate(certificatePath));
		
		System.out.println("******************* 私钥加密-公钥解密 *********************");
		encryptData = encryptByPrivateKey(data.getBytes(),keyStorePath,alias,password);
		decryptData = decryptByPublicKey(encryptData, certificatePath);
		System.out.println("加密前:"+data+"\r\n"+"解密后:"+new String(decryptData));
		
		System.out.println("******************* 私钥签名-公钥验签 *********************");
		String sign = sign(data.getBytes(),keyStorePath,alias,password);
		System.out.println("签名:"+sign);
		boolean verifySign = verifySign(encryptData,sign,certificatePath);
		System.out.println("状态:"+verifySign);
	}
