...
public class ZipUtil {
     ...
     * @return 最终的压缩文件存放的绝对路径,如果为null则说明压缩失败. 
     */  
    private static String zip(String src, String dest, boolean isCreateDir, String passwd) {  
